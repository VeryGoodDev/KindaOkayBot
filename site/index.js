...
`,Ge=()=>c("header",{class:Be},c("a",{class:qe,href:E.HOME},c("img",{alt:"Bot",src:"../src/img/kindaokaybot.png"})),c("nav",{class:Ke},c("a",{href:E.COMMANDS},"Commands"))),de=Ge;var Ye=T(()=>import("./HomePage-7B4ORUVP.js")),Ze=T(()=>import("./CommandsPage-EDZMV2IP.js")),E=(()=>{let t=window.location.hostname==="localhost"?"/":"/kindaokaybot";return{COMMANDS:`${t}/commands`.replace("//","/"),HOME:t}})(),Je=()=>c(_,null,c(pe,null),c(de,null),c("main",null,c(I,null,c(x,{fallback:"Loading...",path:E.HOME},c(Ye,null)),c(x,{fallback:"Loading commands...",path:E.COMMANDS},c(Ze,null)),c(te,{component:fe,default:!0})))),he=Je;w(c(he,null),document.querySelector("#app"));
