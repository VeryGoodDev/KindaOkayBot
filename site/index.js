...
`,je=()=>n("header",{class:ze},n("a",{class:Be,href:k.HOME},n("img",{alt:"Bot",src:k.BOT_IMAGE})),n("nav",{class:Fe},n("a",{href:k.COMMANDS},n(z,{color:"currentColor",size:24}),n("span",null,"Commands")))),se=je;var Ve=oe(()=>import("./CommandsPage-YUG4CLBU.js")),k=(()=>{let t=window.location.hostname==="localhost"?"/":"/kindaokaybot";return{BOT_IMAGE:"./src/img/kindaokaybot.png",COMMANDS:`${t}/commands`.replace("//","/"),HOME:t}})(),Ge=()=>n(p,null,n(re,null),n(se,null),n("main",null,n($,null,n(T,{component:ie,path:k.HOME}),n(E,{fallback:"Loading commands...",path:k.COMMANDS},n(Ve,null)),n(T,{component:ne,default:!0}))),n(ae,null)),ue=Ge;M(n(ue,null),document.querySelector("#app"));
